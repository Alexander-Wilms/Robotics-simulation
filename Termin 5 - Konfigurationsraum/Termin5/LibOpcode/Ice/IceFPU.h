...
#else
	inline_ float FastSqrt(float square) { return sqrt(square); }
#endif
...
#else
	inline_ float FCMax2(float a, float b) { return a > b ? a : b; }
#endif
...
#else
	inline_ float FCMin2(float a, float b) { return a < b ? a : b; }
#endif
...
#else
	inline_ float FCMax3(float a, float b, float c) { return a > b ? FCMax2(a, c) : FCMax2(b, c); }
#endif
...
#else
	inline_ float FCMin3(float a, float b, float c) { return a < b ? FCMin2(a, c) : FCMin2(b, c); }
#endif
